...
import HitboxHandler from './HitboxHandler.js'

const GameSetup = {
  initLevels: () => {
    const backgrounds = {
      hills: {
        src: "/images/platformer/hills.png",
        hitboxes: HitboxHandler.getHitBoxes("hills")
      },
      planet: {
        src: "/images/platformer/planet.jpg",
        hitboxes: HitboxHandler.getHitBoxes("planet")
      }
    }
